...
function HomeLayout({ children }) {
  ...
  return (
    <div className="">
      {/* {Top View} */}
      <div className="w-full sticky top-0 z-50 flex md:pl-[4%] bg-teal-400">
      ...
      <div className="w-full sticky md:top-10 top-[15px] z-50 flex  justify-between h-auto text-black bg-white md:p-4 px-2 py-1 md:py-4">
        <div className="md:w-[20%] h-[40px] w-[50%] flex justify-start items-center">
          <Link to="/">
            <img
              className="w-[60%] md:w-[80%] lg:w-[66%] md:pl-[10%] lg:pl-[17%]"
        ...
        <div className=" hidden md:block md:w-[85%]  top-[80%]  w-full">
          <ul className="flex  p-2 flex-col md:flex-row md:justify-center lg:justify-end gap-[40px] lg:mr-[6%] pt-2">
            <li>
              <Link
                to="/service"
                className="text-[18px] lg:text-[20px]  font-semibold hover:bg-gradient-to-r hover:from-teal-400 hover:to-blue-500 hover:text-transparent hover:bg-clip-text transition-all ease-in-out duration-300"
              >
                Our Service
              </Link>
            </li>
